            ...
            <div class="masonry">
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__text">
						...
						<div class="entry__meta d-flex align-items-center pt-5 mt-auto">
						<div class="avatar avatar-lg mr-3" style="background-image: url(./images/avatars/user-03.jpg)"></div>
                      <div>
                        <a href="./profile.html" class="text-default">Bobby Knight</a>
                        <small class="d-block text-muted">3 days ago</small>
                      </div>
                      <div class="ml-auto text-muted">
                        <a href="javascript:void(0)" class="icon d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i></a>
						<!--d-none -->
                      </div>
					</div>
                    </div>
